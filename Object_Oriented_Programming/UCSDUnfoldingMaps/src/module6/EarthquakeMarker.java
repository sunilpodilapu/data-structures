...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	// modify compareTo method so Java knows how to compare earthquakes
	...
	public void showInfo(PGraphics pg) {
		...
		pg.fill(255, 250, 240);
		pg.rect(25, 25, pg.textWidth(title) + 10, 145);

		pg.stroke(150);
		pg.fill(0);
		pg.text(name, (pg.textWidth(title) / 2) - 5, 40);

		pg.text(title, 30, 60);
		pg.text("Magnitude: " + getMagnitude(), 30, 80);
		pg.text("Radius: " + getRadius(), 30, 100);
		pg.text("Depth: " + getDepth(), 30, 120);
		pg.text("Age: " + getAge(), 30, 140);
		pg.text("Is on land: " + land, 30, 160);
